// - створити функцію яка обчислює та повертає площу прямокутника зі сторонами а і б
    function calculateTheAreaOfRectangle (height, width) {
        return `Площа прямокутника = ${height * width}`;
    }
...
// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
    function calculateTheAreaOfCylinder (height, radius) {
...
function creatorList2 (textLi, countLi) {
    document.write('<ul>');
